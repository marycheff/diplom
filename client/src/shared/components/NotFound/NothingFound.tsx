...
const NothingFound = ({ title, description }: NothingFoundProps) => {
	...
	return (
		<div className={styles.emptyState}>
			...
			<h2 className={styles.title}>{title || "Ничего не найдено"}</h2>
			<p className={styles.description}>
				{description ||
					"К сожалению, мы не можем найти то, что вы ищете. Пожалуйста, проверьте ваш запрос и попробуйте снова."}
			</p>
